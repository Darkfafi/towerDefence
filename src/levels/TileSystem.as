package levels 
{
	...
	public class TileSystem
	{
		...
		{
			// 0 = grond/usedTile, 1 = buildAbleTile, 2 = roadTile, 3 = main base, 4 = enemySpawnPoints, 5 = towerTile(in make) , 6 = tile in unitGebruik (dus verader een tile naar 1 als je een toren verkoopt en naar 0 als je er 1 plaatst etc etc).
